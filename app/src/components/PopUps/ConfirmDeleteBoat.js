...
class ConfirmDeleteBoat extends Component {
  constructor(props) {
    super(props);
        ...
        <Col sm="12">
          <Row>
            ...
            <Col sm="12" className="modal-title-container">
              <h4>
                <FormattedMessage
                  id="modals.confirm_delete_boat.title"
            ...
            <Col sm="12" className="modal-body-container">
              <FormattedMessage
                id="modals.confirm_delete_boat.body"
