...
class IdiomList extends Component {
  constructor(props) {
    ...
    this.state = {
      newEvents: this.props.initialValues?this.initvalues(this.props.initialValues,this.props.lang):[],
      eventId:this.props.initialValues?this.props.initialValues.length:0,
      newValueEvents:[]
    };
    ...
    return (
      <React.Fragment>
        ...
        <div className="addNewEvents">
          ...
          <AddButton
            FormattedMessageId="new_room_3.add_new_idiom"
